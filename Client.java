...
public class Client {
    ...
    public static void main(String[] args) {
        try {
            ...
            while (!loggedIn) {
                System.out.println("\nChoose an action: 'login' or 'register' or 'game' (type 'exit' to quit):");
                ...
                if (!"login".equals(action) && !"register".equals(action) && !"game".equals(action)) {
                    System.out.println("Invalid action. Please choose 'login' or 'register'.");
                    continue;
                }
                
                // if user wants to play mini game
